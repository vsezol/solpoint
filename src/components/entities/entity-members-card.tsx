  ...
  return (
    <>
                ...
                {members.length > 5 && (
                  <div className="text-center">
                    ...
                    {isAuthenticated && !isVip ? (
                      ...
                      <Link
                        href={`${getEntityPath(entitySlug)}?tab=members`}
                        className="text-xs text-[var(--color-primary)] hover:underline"
                      >
                        Show all members
                      </Link>
      ...
      <ProSubscriptionModal
        ...
        description={`Viewing all ${entityName} members is available only with PRO subscription. Upgrade to PRO to unlock this feature.`}
      />
    </>
  );
}
