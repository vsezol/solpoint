    ...
    <section className="relative min-h-[100svh] pt-0 md:pt-16 overflow-hidden flex flex-col">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-x-0 top-[6vh] flex justify-center md:left-auto md:right-0 md:top-1/2 md:-translate-y-1/2 md:justify-end md:pr-1 lg:pr-4 xl:pr-6">
          <div className="pointer-events-auto h-[300px] w-[300px] sm:h-[400px] sm:w-[400px] md:h-[520px] md:w-[520px] lg:h-[620px] lg:w-[620px] xl:h-[700px] xl:w-[700px] 2xl:h-[760px] 2xl:w-[760px] opacity-70 sm:opacity-80 lg:opacity-92">
      ...
      {/* Content */}
      <div className="relative z-20 mx-auto flex flex-1 w-full max-w-7xl flex-col justify-end px-4 pb-24 sm:px-6 md:justify-center md:px-8 md:pb-0 md:pt-20">
      ...
      {/* Scroll indicator */}
      <div className="relative z-20 flex justify-center pb-6 md:pb-10">
        <button
          onClick={() => {
        ...
        >
          ...
          <ChevronDown className="w-6 h-6 text-[var(--color-primary)] animate-bounce" />
        </button>
      </div>
    </section>
  );
