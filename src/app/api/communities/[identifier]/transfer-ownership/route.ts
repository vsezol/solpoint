...
/**
 * POST /api/communities/[identifier]/transfer-ownership
 * Передать владение комьюнити другому пользователю (работает с ID или slug)
 */
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ community: updatedCommunity, success: true });
  } catch (error: any) {
    return NextResponse.json(
