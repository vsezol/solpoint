...
export function EditProfileButton() {
  ...
  return (
    <Button
      variant="outline"
      size="sm"
      className="group bg-black/70 text-white border-white/30 backdrop-blur-md shadow-2xl hover:bg-black/90 hover:border-white/50 hover:scale-105 hover:shadow-[0_12px_40px_rgba(0,0,0,0.6)] active:scale-100 transition-all duration-200 font-extrabold cursor-pointer"
      style={{
